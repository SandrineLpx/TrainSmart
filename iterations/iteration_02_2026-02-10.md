...
### Session system update: renamed to T/S/H
...
## Prompt iteration 3: T/S/H + intensity options

### Problem
The older labels were abstract and didn't convey what each session focused on. Also, there was no way to express "I want to train fewer days but still cover everything."

### Before (v2):
> Session types used abstract labels and one intensity level: as prescribed.
