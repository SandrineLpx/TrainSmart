...
## Historical note
This log captures the state on 2026-02-09. References to older session labeling and `training_log.json` are historical, not current architecture.
...
### Config
- **`CLAUDE.md`** — Project memory: athlete profile, session system, decision rules, stop rules, file paths.
